...
Revised Case J validates that tightened Tier 0 contract; Case K validates one parallel wave with two independent Implementer children and isolated reported actor artifacts. Both deterministic preflights PASS. Authenticated reruns are pending because Codex usage quota was exhausted on 2026-09-25; revised Case J nevertheless reached installed automatic preparation persistence before Implementer spawn, while Case K was blocked at turn start. The older authenticated Case J PASS covered the superseded Lead-direct contract and is not treated as evidence for the revised contract.
